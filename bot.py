...
status = cycle(
    [f'Try {prefix}help',f'Prefix - {prefix}','Gta Online'])
...
apartmentsshop = [{"name":"Item here","price":100,"description":"Item  Discription here"},
            {"name":"Item here","price":1000,"description":"Item  Discription here"},
            {"name":"Item here","price":10000,"description":"Item  Discription here"},
            {"name":"Item here","price":99999,"description":"Item  Discription here"}]
...
async def shop(ctx):
    ...
    await ctx.send(embed = em)
@client.command()
async def apartmentshop(ctx):
    em = discord.Embed(title = "Apartment Shop")

    for item in apartmentsshop:
        name = item["name"]
        price = item["price"]
        desc = item["description"]
        em.add_field(name = name, value = f"${price} | {desc}")
